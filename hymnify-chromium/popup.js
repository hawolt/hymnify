document.addEventListener('DOMContentLoaded', function () {
    ...
    function addToWhitelist(value) {
        chrome.storage.sync.get('hymnify_whitelist', function (result) {
            ...
            chrome.storage.sync.set({ 'hymnify_whitelist': currentWhitelist });
        });
    }
    ...
    function removeFromWhitelist(value) {
        chrome.storage.sync.get('hymnify_whitelist', function (result) {
            ...
            chrome.storage.sync.set({ 'hymnify_whitelist': updatedWhitelist });
        });
    }
    ...
    function storeUpdateDelayValue() {
        ...
        chrome.storage.sync.set({ 'hymnify_delay': updateDelayValue }, function () {
